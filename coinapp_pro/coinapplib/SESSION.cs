...
namespace coinapplib
{
    public class SESSION
    {
        ...
        private string _SERVER_LOCK { get; set; } = "LOCK_BY_SERVER";
        private string _SERVER_UNLOCK { get; set; } = "UNLOCK_BY_SERVER";
        private string _SERVER_LOGOUT { get; set; } = "LOGOUT_BY_SERVER";
        ...
        public string ToString(int session)
        {
            switch (session)
            {
                ...
                case 12: return _SERVER_LOCK;
                case 13: return _SERVER_UNLOCK;
                case 14: return _SERVER_LOGOUT;
